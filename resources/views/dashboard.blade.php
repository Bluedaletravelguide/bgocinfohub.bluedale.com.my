...
@section('head')
    ...
    <style>
        ...
        #previewTable .section-header-cell {
            ...
            /* 🔴 CHANGED: #1f4e78 (blue) → #dc2626 (red) */
        }
    ...
    <div class="dashboard-wrapper page-dashboard">
            ...
            <div class="toolbar-content">
                ...
                <div class="toolbar-actions">
                    @can('export', \App\Models\Item::class)
                        ...
                        <button id="btnPreviewTables" type="button"
                        ...
                        <button id="btnCompletedTasks" type="button"
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border hairline bg-emerald-50 hover:bg-emerald-100 text-emerald-700">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    @role('admin')
                        <button id="btnViewUsers" type="button" class="btn btn-info magnetic">
                            ...
                            <span class="btn-content">
                                <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    style="width:20px;height:20px;display:inline-block;vertical-align:middle;margin-right:4px;">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="form-group animate-fade-in" style="animation-delay: 0.15s;">
                        ...
                        <select id="f_type_label" class="form-select">
                            ...
                            @foreach ($distinct['type_labels'] as $v)
                                <option value="{{ $v }}">{{ strtoupper($v) === 'INTERNAL' ? 'INT' : $v }}
                                </option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="card">
            <div class="table-section glass-morphism slide-in-up" style="animation-delay: 0.2s;">
                ...
                <div id="tableInfo" class="text-xs text-neutral-500 mt-2 px-4 py-2"
                    style="background: rgba(255,255,255,0.5); border-top: 1px solid rgba(229,231,235,0.5);"></div>
            </div>
        </div>
        ...
        <div id="completedModal" class="fixed inset-0 z-[999] hidden">
            ...
            <div class="relative mx-auto my-8 w-[95vw] max-w-7xl bg-white rounded-2xl shadow-xl">
                ...
                <div class="px-6 py-5">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <span id="completedCount"
                            class="px-3 py-1 rounded-full border hairline bg-emerald-50 text-emerald-700 text-sm font-medium">
                            0 completed
                        </span>
                    </div>
                    ...
                    <div id="completedPagination" class="flex items-center justify-between mt-4 pt-4 border-t hairline">
                        <div class="text-xs text-neutral-500">
                            Showing <span id="completedShowingStart">0</span>-<span id="completedShowingEnd">0</span> of
                            <span id="completedTotal">0</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <button id="completedPrevPage"
                                class="px-3 py-1 rounded-lg border hairline hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed text-sm">
                                Previous
                            </button>
                            <span id="completedPageInfo" class="text-sm text-neutral-600">Page 1</span>
                            <button id="completedNextPage"
                                class="px-3 py-1 rounded-lg border hairline hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed text-sm">
                                Next
                            </button>
                        </div>
                ...
                <div class="flex items-center justify-between gap-3 px-6 py-4 border-t hairline">
                    ...
                    <button id="completedClose2"
                        class="px-4 py-2 rounded-xl border hairline bg-white hover:bg-neutral-50">Close</button>
                </div>
            </div>
        </div>
            ...
            <form id="createForm">
                ...
                <div class="modal-form-grid">
                    ...
                    <div class="modal-form-group">
                        ...
                        <input type="text" name="assign_by_id" placeholder="Enter Assign By"
                            class="modal-form-input">
                    </div>
                    <div class="modal-form-group">
                        <label class="modal-form-label">Assign To</label>
                        <input type="text" name="assign_to_id" placeholder="Enter Assign To"
                            class="modal-form-input">
                    </div>
                    <div class="modal-form-group">
                    ...
                    <div class="modal-form-group">
                        ...
                        <input type="text" name="company_id" placeholder="Enter Company Name/ID"
                            class="modal-form-input">
                    </div>
                    <div class="modal-form-group">
                    ...
                    <div class="modal-form-group">
                        ...
                        <input type="text" name="pic_name" maxlength="150" placeholder="Enter PIC Name"
                            class="modal-form-input">
                    </div>
                    <div class="modal-form-group">
                        <label class="modal-form-label">Department</label>
                        <input type="text" name="product_id" placeholder="Enter Department Name/ID"
                            class="modal-form-input">
                    ...
                    <div class="modal-form-group full-width">
                        ...
                        <textarea name="remarks" rows="3" placeholder="Enter any additional notes or remarks..."
    ...
    <div id="previewModal" class="fixed inset-0 z-[999] hidden">
        ...
        <div class="relative mx-auto my-8 w-[95vw] max-w-7xl bg-white rounded-2xl shadow-xl">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b hairline">
                ...
                <button id="previewClose" class="p-2 rounded-lg hover:bg-neutral-100"
            ...
            <div class="flex items-center justify-between gap-3 px-6 py-4 border-t hairline">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('dashboard.items.export') }}"
                        class="px-4 py-2 rounded-xl bg-[#22255b] text-white hover:opacity-90">
                        Go to Export
                    </a>
                    <button id="previewClose2"
                        class="px-4 py-2 rounded-xl border hairline bg-white hover:bg-neutral-50">Close</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function renderCompletedTable(page = 1) {
            ...
            const columns = [{
                    key: '_no',
                    label: 'No',
                    render: (_r, i, startIdx) => startIdx + i + 1
                },
                {
                    key: 'date_in',
                    label: 'Date In',
                ...
                },
                {
                    key: 'company_name',
                    label: 'Company',
                    render: r => (r.company_name ?? r.company_id ?? '')
                },
                {
                    key: 'pic_name',
                    label: 'PIC'
                ...
                },
                {
                    key: 'product_name',
                    label: 'Department',
                    render: r => (r.product_name ?? r.product_id ?? '')
                },
                ...
                },
                {
                    key: 'type_label',
                    label: 'Int/Client',
                    render: r => uiTypeLabel(r.type_label)
                },
                {
                    key: 'action',
                    label: 'Action'
                ...
                btn.addEventListener('click', async function() {
                    ...
                    try {
                        ...
                        const res = await fetch(
                            `{{ route('dashboard.items.update', ['id' => '__ID__']) }}`.replace(
                                '__ID__', id), {
                                method: 'PATCH',
                                headers: {
                                    'X-CSRF-TOKEN': CSRF,
        ...
        function renderSummaryChips(rows) {
            ...
            const chip = (label, value, opts = {}) => {
                ...
                const classes =
                    `chip inline-flex items-center gap-2 px-3 py-1 rounded-full border hairline cursor-pointer select-none${active}`;
  ...
  `;
        ...
        function renderPreviewTable(rows) {
            ...
            const columns = [{
                ...
                {
                    key: 'assign_by_id',
                    labelHtml: '<span class="th-2line"><span class="top">ASSIGN</span><span class="sub">BY</span></span>'
                },
                {
                    key: 'assign_to_id',
                    labelHtml: '<span class="th-2line"><span class="top">ASSIGN</span><span class="sub">TO</span></span>'
                },
                {
                    key: 'company_name',
                    label: 'Company',
                ...
                },
                {
                    key: 'status',
                    label: 'Status',
                    render: r => getStatusSelect(r)
                },
                {
                    key: 'action',
                    label: 'Action',
                    render: r => getDeleteBtn(r)
                },
            ];
        ...
        $(function() {
            try {
                ...
                (function modalBackdropGuard() {
                    const modalIds = ['previewModal', 'completedModal', 'createModal', 'editModal',
                        'detailModal'
                    ];
                    modalIds.forEach(id => {
                ...
                pvBody?.addEventListener('click', async (ev) => {
                    ...
                    try {
                        const res = await fetch(
                            `{{ route('dashboard.items.destroy', ['id' => '__ID__']) }}`.replace(
                                '__ID__', id), {
                                method: 'POST',
                                headers: {
                                    'X-CSRF-TOKEN': CSRF,
...
`;
                ...
                function startAutoRefresh() {
                    ...
                    refreshTimer = setInterval(() => fetchData({
                        resetWindow: false,
                        silent: true
                    }), 3000);
                }
